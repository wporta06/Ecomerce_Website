...
@section('content')
    ...
    <section class="curved ">
        ...
        <div class="container text-center ">
            ...
            <p class="text-warning">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora, laudantium quaerat asperiores at velit
            ...
            <br>
            <h1 class="text-white"><i class="fas fa-hiking text-warning"></i> BEST SELLER <i class="fas fa-mountain text-warning"></i></h1>
            <br>
